...
export class Emulator {
    ...
    */
    load(data) {
        wasm.emulator_load(this.__wbg_ptr, addHeapObject(data));
    }
    /**
    */
    exec() {
        wasm.emulator_exec(this.__wbg_ptr);
    }
    /**
    * @returns {boolean}
    */
    can_draw() {
        const ret = wasm.emulator_can_draw(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    */
    un_draw() {
        wasm.emulator_un_draw(this.__wbg_ptr);
    }
    /**
    * @returns {number}
    */
    get_delay_timer() {
        const ret = wasm.emulator_get_delay_timer(this.__wbg_ptr);
        return ret;
    }
    /**
    */
    tick_delay_timer() {
        wasm.emulator_tick_delay_timer(this.__wbg_ptr);
    }
    /**
    ...
    */
    keypress(evt, state) {
        wasm.emulator_keypress(this.__wbg_ptr, addHeapObject(evt), state);
    }
    /**
    * @returns {Uint32Array}
    */
    get_buffer() {
        try {
            ...
            wasm.emulator_get_buffer(retptr, this.__wbg_ptr);
